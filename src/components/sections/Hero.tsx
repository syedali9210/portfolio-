...
function DockIconRow({ icons }: { icons: string[] }) {
  return (
    <div className="flex items-center gap-2 rounded-xl border border-border bg-[#080808] px-3 py-3">
      {icons.map((src, i) => (
        <div
          key={i}
...
export default function Hero() {
  return (
    <section id="home" className="relative w-full">
      <div className="relative mx-auto hidden h-[280px] w-full max-w-[1040px] border-x border-border sm:block sm:h-[340px] lg:h-[434px]">
        <Image
      ...
      {/* Profile bar */}
      <FadeIn>
        <div className="mx-auto flex w-full max-w-[1040px] flex-col border-x border-b border-border md:flex-row md:justify-between">
          <div className="flex w-full flex-col">
            <div className="flex items-center gap-2 border-b border-border px-4 py-3">
              <div className="relative size-[47px] shrink-0 overflow-hidden rounded-full border border-border bg-[#161618] shadow-[inset_0_0_10px_0_#232323]">
            ...
            <div className="grid grid-cols-1 gap-x-4 gap-y-3 border-b border-border p-4 sm:grid-cols-2">
              {INFO_ITEMS.map((item) => (
                <div
                  key={item.label}
                  className={`flex items-center gap-4 ${item.full ? "sm:col-span-2" : ""}`}
                >
                  <div className="flex size-6 shrink-0 items-center justify-center rounded-md border border-white/10 bg-[#27272a]">
          ...
          <div className="flex shrink-0 items-center justify-center gap-4 border-t border-border p-4 md:flex-col md:justify-start md:border-t-0 md:border-l">
            ...
            <button
              ...
              disabled
              className="flex size-[42px] items-center justify-center rounded-full border border-[#39393d] bg-[#262628] shadow-[inset_0_0_10px_0_#232323] disabled:cursor-not-allowed"
            >
      ...
      {/* Dock */}
      <div className="mx-auto w-full max-w-[1040px] border-x border-b border-border px-4 py-10 sm:px-8">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <FadeIn delay={0.05} className="flex flex-col gap-3">
            <DockIconRow icons={DOCK_COLUMN_A.icons} />
            <div className="overflow-hidden rounded-xl border border-border bg-[#080808] p-3">
          ...
          <FadeIn delay={0} className="flex flex-col gap-3">
            <div className="flex flex-col gap-3 rounded-xl border border-border bg-[#080808] p-3">
          ...
          <FadeIn delay={0.1} className="flex flex-col gap-3">
            ...
            <div className="flex gap-2 overflow-hidden rounded-xl border border-border bg-[#080808] p-3">
        ...
        <div className="mt-10 flex flex-col">
          <div className="flex items-center justify-between border-y border-border py-1">
          ...
          {[
            ...
            <div key={item.n} className="flex gap-6 border-b border-border py-4 sm:gap-10">
